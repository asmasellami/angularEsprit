...
export class CardComponent {
 Eventlist:Event[]=[
  ...
  event:Event={id:1,titre:"Concert de Rock",description:"Un concert de rock avec des groupes locaux.",date:new Date("2026-11-15"),lieu:"Salle des Fêtes",prix:30,organisateurId:1,imageUrl:"/images/concert.jpg",nbPlaces:100,nbLikes:45};
